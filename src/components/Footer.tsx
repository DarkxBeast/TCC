            ...
            >
              ...
              <ul className="space-y-4">
                <motion.li variants={linkVariants} whileHover="hover">
                  <Link
                    href="/"
                    className="text-white/80 hover:text-white transition-colors inline-block relative 
after:content-[''] after:absolute after:w-full after:h-[2px] after:bg-[#FF9E44] after:left-0 after:-bottom-1 
